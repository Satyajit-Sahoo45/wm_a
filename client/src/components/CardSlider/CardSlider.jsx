...
import { cardImages } from "../../utils/card-slider"
...
export const CardSlider = () => {
    ...
    const handlePrev = () => {
        setCurrentIndex((prevIndex) => (prevIndex - 1 + cardImages.length) % cardImages.length);
    };
    if (currentIndex > cardImages.length - 3) {
            ...
            <div className="w-11/12 ">
                <div className="relative">
                    ...
                    <div className="flex space-x-4">
                        {cardImages.slice(currentIndex, currentIndex + 3).map((card, index) => (
